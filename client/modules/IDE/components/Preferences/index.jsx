      ...
      <Tabs selectedIndex={tabIndex} onSelect={changeTab}>
        ...
        <TabPanel>
          <div className={classNames.preference}>
            ...
            <fieldset className={classNames.preference__options}>
              <input
                type="radio"
          ...
          <div className={classNames.preference}>
            <h4 className={classNames.preference__title}>{t('Preferences.WordWrap')}</h4>
            <fieldset className={classNames.preference__options}>
              <input
                type="radio"
                ...
                checked={wordwrap}
              />
              <label htmlFor="wordwrap-on" className={classNames.preference__option}>
                {t('Preferences.On')}
              </label>
              <input
                type="radio"
                ...
                checked={!wordwrap}
              />
              <label htmlFor="wordwrap-off" className={classNames.preference__option}>
                {t('Preferences.Off')}
              </label>
            </fieldset>
          </div>
