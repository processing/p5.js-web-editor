...
exports.p5Hinter = [
  ...
  { text: 'endShape', type: 'fun', params: [{ p: 'mode', o: true }], p5: true },
  ...
  { text: 'copy', type: 'fun', p5: true },
  {
    ...
    type: 'fun',
    params: [
      { p: 'filterType', o: false },
      { p: 'filterParam', o: true }
    ],
    p5: true
  },
  ...
  { text: 'loadJSON', type: 'fun', p5: true },
  {
    text: 'loadStrings',
    type: 'fun',
    params: [
  ...
  { text: 'fract', type: 'fun', params: [{ p: 'num', o: false }], p5: true },
  {
    text: 'createVector',
    type: 'fun',
    params: [
  ...
  { text: 'float', type: 'fun', params: [{ p: 'str', o: false }], p5: true },
  { text: 'int', type: 'fun', p5: true },
  { text: 'str', type: 'fun', params: [{ p: 'n', o: false }], p5: true },
  { text: 'boolean', type: 'fun', params: [{ p: 'n', o: false }], p5: true },
